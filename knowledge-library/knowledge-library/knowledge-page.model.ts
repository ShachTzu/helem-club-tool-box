...
import { HELEM_CLUB_AUTHOR_NAME, type KnowledgePageMediaType } from '@helemclub/knowledge-library.entities.knowledge-page';
...
export class KnowledgePageModel {
   ...
   */
  @prop({ type: String })
  public mediaType?: KnowledgePageMediaType;
