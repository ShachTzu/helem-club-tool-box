 ...
 *
 * mirrors toolbox/toolbox/cloudinary-signature.ts byte-for-byte (deliberate
 * copy, not a shared import — see the design doc's "Media" section: this
 * feature owns its own signing mutation and folder, rather than reaching
 * into toolbox's).
 */
 ...
 * needs it rather than crash the whole aspect.
 */
 ...
 */
export function signCloudinaryUpload(params: Record<string, string | number>, apiSecret: string): string {
