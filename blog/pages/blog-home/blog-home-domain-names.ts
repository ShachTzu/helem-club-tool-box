/**
 * default mapping of domain ids to their Hebrew display names, used to
 * resolve the domain ids stored on a post into human-readable chips.
 * override via the `domainNames` prop when a live domains source is
 * available.
 */
