import type { App, Review, Tag } from './types.js';

/** The 14 closed coping-domain tags (from the spec). */
export const TAGS: Tag[] = [
  { name: 'עבודה וקריירה', count: 3 },
  { name: 'לימודים ואקדמיה', count: 2 },
  { name: 'טריגרים', count: 4 },
  { name: 'מיצוי זכויות', count: 1 },
  { name: 'כאב גופני', count: 2 },
  { name: 'משפחה, זוגיות ויחסים', count: 3 },
  { name: 'תרופות ופסיכיאטריה', count: 1 },
  { name: 'בדידות וחיבור חברתי', count: 3 },
  { name: 'שינה', count: 4 },
  { name: 'אשמה, בושה וביקורת עצמית', count: 2 },
  { name: 'חרדה', count: 5 },
  { name: 'ויסות רגשי', count: 4 },
  { name: 'דיכאון ותחושת תקיעות', count: 3 },
  { name: 'מיינדפולנס ונשימות', count: 5 },
];

const shot = (seed: string) =>
  `https://images.unsplash.com/${seed}?auto=format&fit=crop&w=900&q=80`;

/** Seed catalog of published coping apps. */
export const APPS: App[] = [
  {
    ...
    tags: ['מיינדפולנס ונשימות', 'חרדה', 'שינה'],
    avgRating: 4.7,
    ratingCount: 96,
  ...
  },
  {
    ...
    tags: ['שינה', 'מיינדפולנס ונשימות', 'חרדה'],
    avgRating: 4.3,
    ratingCount: 58,
  ...
  },
  {
    ...
    tags: ['ויסות רגשי', 'דיכאון ותחושת תקיעות', 'אשמה, בושה וביקורת עצמית'],
    avgRating: 4.1,
    ratingCount: 47,
  ...
  },
  {
    ...
    tags: ['בדידות וחיבור חברתי', 'משפחה, זוגיות ויחסים', 'דיכאון ותחושת תקיעות'],
    avgRating: 4.5,
    ratingCount: 34,
  ...
  },
  {
    ...
    tags: ['עבודה וקריירה', 'לימודים ואקדמיה', 'ויסות רגשי'],
    avgRating: 4.2,
    ratingCount: 51,
...
/** Sample reviews for the app detail page, ordered by helpfulness. */
